...
export const UNSUPPORTED_NEG_RISK_ADAPTER_MESSAGE = 'This market uses an unsupported NegRisk adapter. Actions are disabled for this market.'
...
export const ZERO_BYTES32 = ZERO_COLLECTION_ID
...
export function assertCurrentNegRiskAdapterAddress(value: string | null | undefined): `0x${string}` {
  if (!isCurrentNegRiskAdapterAddress(value)) {
    throw new Error(UNSUPPORTED_NEG_RISK_ADAPTER_MESSAGE)
  }
